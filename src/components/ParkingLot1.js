...
const ParkingLot1 = ({lot, spSlotNumber}) => {
        ...
        <>
            ...
            <div className={classes.parkArea}>
                ...
                {slots.slice(0, 16).map(ps =>
                    <ParkingSlot suitable={ps.slotNumber === spSlotNumber}
            ...
            <div className={classes.parkArea}>
                ...
                <ParkingSlot slotNumber={slots[45].slotNumber} horizontal slotStatus={slots[45].slotStatus}/>
